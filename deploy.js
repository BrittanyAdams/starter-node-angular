...
function cloneRepo() {
  ...
  cmd.get(
    'rm -rf starter-node-angular-master && git clone https://github.com/scotch-io/starter-node-angular-master.git',
...
function transferProjectToRemote(failed, successful) {
  return ssh.putDirectory(
    __dirname + '/starter-node-angular-master',
    '/home/ubuntu/starter-node-angular-master-temp',
    {
      recursive: true,
      concurrency: 1,
...
function createRemoteTempFolder() {
  return ssh.execCommand(
    'rm -rf starter-node-angular-master-temp && mkdir starter-node-angular-master-temp',
    { cwd: '/home/ubuntu' }
  );
}
...
function updateRemoteApp() {
  return ssh.execCommand(
    'cp -r starter-node-angular-master-temp/* starter-node-angular-master/ && rm -rf starter-node-angular-master-temp/*',
    { cwd: '/home/ubuntu' }
  );
}
...
function sshConnect() {
  ...
  ssh
    ...
    .then(function() {
      ...
      // Create "starter-node-angular-master-temp" directory on remote server
      console.log('Creating `starter-node-angular-master-temp` folder.');
